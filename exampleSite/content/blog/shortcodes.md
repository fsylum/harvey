...
Read more on [cross-references](https://gohugo.io/extras/crossreferences/).
...
If the page exists in multiple [output formats](https://gohugo.io/extras/output-formats/),  `ref` or `relref` can be used with a output format name:
